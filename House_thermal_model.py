...
#plt.plot(t[1:], [-i/1000 for i in losses_registry[0]], 'r', label='Roof')
#plt.plot(t[1:], [-i/1000 for i in losses_registry[1]], 'b', label='Windows')
#plt.plot(t[1:], [-i/1000 for i in losses_registry[2]], 'g', label='Walls')
